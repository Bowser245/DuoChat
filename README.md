...
- **Recherche d'utilisateurs :** Système de "Phare" P2P pour vérifier si un ami est en ligne et obtenir son code de salon.
- **Thèmes personnalisés :** Modes Light, Dark et un mode Hacker spécial Matrix.
